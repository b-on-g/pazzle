...
declare namespace $ {
	...
	type $mol_button_major__hint_bog_pazzle_menu_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['hint'] >
	>
	type $mol_button_major__click_bog_pazzle_menu_2 = $mol_type_enforce<
		ReturnType< $bog_pazzle_menu['play'] >
		,
	...
	>
	type $mol_button_major__hint_bog_pazzle_menu_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['hint'] >
	>
	type $mol_button_major__click_bog_pazzle_menu_5 = $mol_type_enforce<
		ReturnType< $bog_pazzle_menu['home'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_major__sub_bog_pazzle_menu_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_button_minor__hint_bog_pazzle_menu_7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_pazzle_menu_8 = $mol_type_enforce<
		ReturnType< $bog_pazzle_menu['saves'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_pazzle_menu_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_button_minor__hint_bog_pazzle_menu_10 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_pazzle_menu_11 = $mol_type_enforce<
		ReturnType< $bog_pazzle_menu['help'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_pazzle_menu_12 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	export class $bog_pazzle_menu extends $mol_list {
		Resume_icon( ): $mol_icon_play
		Resume( ): $mol_button_major
		New_icon( ): $mol_icon_image_plus
		New( ): $mol_button_major
		Saves_icon( ): $mol_icon_content_save
		saves_label( ): string
		Saves( ): $mol_button_minor
		...
		saves( next?: any ): any
		help( next?: any ): any
		rows( ): ReturnType< $bog_pazzle_menu['menu_content'] >
	}
...
declare namespace $.$$ {
    class $bog_pazzle_menu extends $.$bog_pazzle_menu {
...
declare namespace $ {
    ...
    type $bog_pazzle_store_move = {
        order: readonly number[];
        moves: number;
    };
    /** Партии и картинки в localStorage. */
    class $bog_pazzle_store extends $mol_object {
        ...
        static draft: string;
        static cell<Value>(key: string, next?: Value | null): Value | null;
        static ids(next?: readonly string[] | null): readonly string[];
        static save(id: string, next?: $bog_pazzle_store_save | null): $bog_pazzle_store_save | null;
        static image(id: string, next?: string | null): string;
        static thumb(id: string, next?: string | null): string;
        /** Партия, которую открывает экран игры. */
        static current(next?: string | null): string;
        static patch(id: string, patch: Partial<$bog_pazzle_store_save>): $bog_pazzle_store_save | null;
        ...
        static spacious(write: () => void): void;
        static forget(id: string): void;
        static drop(id: string): void;
        static shuffled(count: number): readonly number[];
        static assembled(order: readonly number[]): boolean;
        /** Сколько секундомер натикал с последнего хода. Долгая пауза не идёт в зачёт. */
        static gap(save: $bog_pazzle_store_save | null, now: number): number;
        static clock(ms: number): string;
        /** «1 ход», «2 хода», «5 ходов». */
        static moves_label(count: number): string;
        static day(stamp: number): string;
    }
}
...
declare namespace $ {
	...
	type $mol_text__text_bog_pazzle_board_victory_2 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board_victory['stats'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_text__text_bog_pazzle_board_victory_3 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board_victory['best'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_button_major__title_bog_pazzle_board_victory_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_pazzle_board_victory_5 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board_victory['again'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_minor__title_bog_pazzle_board_victory_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_pazzle_board_victory_7 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board_victory['home'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__title_bog_pazzle_board_victory_8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_pazzle_board_victory_9 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board_victory['saves'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_row__sub_bog_pazzle_board_victory_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_row['sub'] >
	>
	type $mol_list__rows_bog_pazzle_board_victory_11 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board_victory['card_content'] >
		,
		ReturnType< $mol_list['rows'] >
	>
...
declare namespace $.$$ {
    class $bog_pazzle_board_tile extends $.$bog_pazzle_board_tile {
        ...
        repos_x(shift: number): number;
        repos_y(shift: number): number;
        columns_safe(): number;
        rows_safe(): number;
        piece_row(): number;
        piece_column(): number;
        ...
        attr(): {
            'data-pazzle-slot': string;
            bog_pazzle_selected: boolean;
            bog_pazzle_playable: boolean;
        };
    }
}
...
declare namespace $ {
	...
	type $mol_view__style_bog_pazzle_board_2 = $mol_type_enforce<
		({ 
			'gridTemplateColumns': ReturnType< $bog_pazzle_board['grid_columns'] >,
			'gridTemplateRows': ReturnType< $bog_pazzle_board['grid_rows'] >,
			'aspectRatio': ReturnType< $bog_pazzle_board['grid_ratio'] >,
		}) 
		,
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__attr_bog_pazzle_board_3 = $mol_type_enforce<
		({ 
			'bog_pazzle_assembled': ReturnType< $bog_pazzle_board['merged'] >,
		}) 
		,
		ReturnType< $mol_view['attr'] >
	>
	type $mol_view__sub_bog_pazzle_board_4 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tiles'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_image__uri_bog_pazzle_board_5 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['image_uri'] >
		,
		ReturnType< $mol_image['uri'] >
	>
	type $mol_image__title_bog_pazzle_board_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_image['title'] >
	>
	type $bog_pazzle_board_victory__moves_bog_pazzle_board_7 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['moves'] >
		,
		ReturnType< $bog_pazzle_board_victory['moves'] >
	>
	type $bog_pazzle_board_victory__time_bog_pazzle_board_8 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['time'] >
		,
		ReturnType< $bog_pazzle_board_victory['time'] >
	>
	type $bog_pazzle_board_victory__best_bog_pazzle_board_9 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['best'] >
		,
		ReturnType< $bog_pazzle_board_victory['best'] >
	>
	type $bog_pazzle_board_victory__again_bog_pazzle_board_10 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['again'] >
		,
		ReturnType< $bog_pazzle_board_victory['again'] >
	>
	type $bog_pazzle_board_victory__home_bog_pazzle_board_11 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['home'] >
		,
		ReturnType< $bog_pazzle_board_victory['home'] >
	>
	type $bog_pazzle_board_victory__saves_bog_pazzle_board_12 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['saves'] >
		,
		ReturnType< $bog_pazzle_board_victory['saves'] >
	>
	type $mol_view__style_bog_pazzle_board_13 = $mol_type_enforce<
		({ 
			'maxWidth': ReturnType< $bog_pazzle_board['field_width'] >,
		}) 
		,
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__sub_bog_pazzle_board_14 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['field_content'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_pazzle_board_tile__rows_bog_pazzle_board_15 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['rows'] >
		,
		ReturnType< $bog_pazzle_board_tile['rows'] >
	>
	type $bog_pazzle_board_tile__columns_bog_pazzle_board_16 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['columns'] >
		,
		ReturnType< $bog_pazzle_board_tile['columns'] >
	>
	type $bog_pazzle_board_tile__image_uri_bog_pazzle_board_17 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['image_uri'] >
		,
		ReturnType< $bog_pazzle_board_tile['image_uri'] >
	>
	type $bog_pazzle_board_tile__playable_bog_pazzle_board_18 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['playable'] >
		,
		ReturnType< $bog_pazzle_board_tile['playable'] >
	>
	type $bog_pazzle_board_tile__locked_bog_pazzle_board_19 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tile_locked'] >
		,
		ReturnType< $bog_pazzle_board_tile['locked'] >
	>
	type $bog_pazzle_board_tile__piece_bog_pazzle_board_20 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tile_piece'] >
		,
		ReturnType< $bog_pazzle_board_tile['piece'] >
	>
	type $bog_pazzle_board_tile__slot_bog_pazzle_board_21 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tile_slot'] >
		,
		ReturnType< $bog_pazzle_board_tile['slot'] >
	>
	type $bog_pazzle_board_tile__label_bog_pazzle_board_22 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tile_label'] >
		,
		ReturnType< $bog_pazzle_board_tile['label'] >
	>
	type $bog_pazzle_board_tile__selected_bog_pazzle_board_23 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tile_selected'] >
		,
		ReturnType< $bog_pazzle_board_tile['selected'] >
	>
	type $bog_pazzle_board_tile__drags_synced_bog_pazzle_board_24 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tile_synced'] >
		,
		ReturnType< $bog_pazzle_board_tile['drags_synced'] >
	>
	type $bog_pazzle_board_tile__on_drag_start_bog_pazzle_board_25 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tile_press'] >
		,
		ReturnType< $bog_pazzle_board_tile['on_drag_start'] >
	>
	type $bog_pazzle_board_tile__on_drag_bog_pazzle_board_26 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tile_drag'] >
		,
		ReturnType< $bog_pazzle_board_tile['on_drag'] >
	>
	type $bog_pazzle_board_tile__on_drag_end_bog_pazzle_board_27 = $mol_type_enforce<
		ReturnType< $bog_pazzle_board['tile_drop'] >
		,
		ReturnType< $bog_pazzle_board_tile['on_drag_end'] >
	>
	export class $bog_pazzle_board extends $mol_view {
		...
		field_content( ): readonly(any)[]
		Field( ): $mol_view
		board_content( ): readonly(any)[]
		tile_locked( id: any): boolean
		tile_piece( id: any): number
		tile_slot( id: any): number
		tile_label( id: any): string
		tile_selected( id: any): boolean
		tile_synced( id: any): readonly(any)[]
		tile_press( id: any, next?: any ): any
		tile_drag( id: any, next?: any ): any
		tile_drop( id: any, next?: any ): any
		image_uri( ): string
		rows( ): number
		columns( ): number
		numbers( ): boolean
		...
		home( next?: any ): any
		saves( next?: any ): any
		sub( ): ReturnType< $bog_pazzle_board['board_content'] >
		Tile( id: any): $bog_pazzle_board_tile
	}
...
declare namespace $.$$ {
    ...
    export class $bog_pazzle_board extends $.$bog_pazzle_board {
        ...
        grid_w(): number;
        grid_h(): number;
        slot_row(slot: number): number;
        slot_col(slot: number): number;
        grid_columns(): string;
        grid_rows(): string;
        grid_ratio(): string;
        image_size(): {
        ...
        tile_slot(slot: number): number;
        tile_piece(slot: number): number;
        tile_label(slot: number): string;
        tile_selected(slot: number): boolean;
        ...
        field_width(): string;
        neighbors(slot: number): number[];
        /** Соседние клетки держат соседние куски картинки — значит, они уже склеены. */
        aligned(from: number, to: number, order: readonly number[]): boolean;
        ...
        tile_locked(slot: number): boolean;
         ...
         */
        selection_raw(next?: $bog_pazzle_board_selection): $bog_pazzle_board_selection;
        /** Чтение сверяет ключ вживую — выделение от прошлого пазла не всплывёт. */
        selection(): $bog_pazzle_board_selection;
        select(patch: Partial<$bog_pazzle_board_selection>): void;
        picked(): number | null;
        drag_from(): number | null;
        drag_slots(): readonly number[] | null;
        drop_slots(): readonly number[] | null;
        drag_reset(): void;
        /** Возвращает все фрагменты на свои клетки после перетаскивания. */
        tiles_home(): void;
        slot_at(x: number, y: number): number | null;
        tile_press(slot: number, next?: PointerEvent | null): null;
        tile_drag(slot: number, next?: PointerEvent | null): null;
        tile_drop(slot: number, next?: PointerEvent | null): null;
        /** Тап без перетаскивания: первый выбирает фрагмент, второй меняет их местами. */
        pick(slot: number): void;
        commit(order: readonly number[]): void;
        /** Куда уедет группа при сдвиге на столько строк и столбцов. null — за край доски. */
        shifted(group: readonly number[], shift_row: number, shift_col: number): readonly number[] | null;
        same(a: readonly number[], b: readonly number[]): boolean;
        /** Группа встаёт на новые клетки, вытесненные фрагменты занимают освободившиеся. */
        shift_order(group: readonly number[], dest: readonly number[]): readonly number[] | null;
    }
    export {};
}
...
declare namespace $ {
	...
	type $mol_image__uri_bog_pazzle_upload_image_1 = $mol_type_enforce<
		ReturnType< $bog_pazzle_upload_image['image_uri'] >
		,
		ReturnType< $mol_image['uri'] >
	>
	type $mol_image__title_bog_pazzle_upload_image_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_image['title'] >
	>
	export class $bog_pazzle_upload_image extends $mol_button_open {
		Icon( ): $mol_icon_image_plus
		Preview( ): $mol_image
		hint( ): string
		image_uri( ): string
		picked( next?: any ): any
...
declare namespace $ {
	...
	type $mol_number__value_min_bog_pazzle_settings_1 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_number['value_min'] >
	>
	type $mol_number__value_max_bog_pazzle_settings_2 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_number['value_max'] >
	>
	type $mol_number__value_bog_pazzle_settings_3 = $mol_type_enforce<
		ReturnType< $bog_pazzle_settings['grid_rows'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_number__hint_bog_pazzle_settings_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_number['hint'] >
	>
	type $mol_text__text_bog_pazzle_settings_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_number__value_min_bog_pazzle_settings_6 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_number['value_min'] >
	>
	type $mol_number__value_max_bog_pazzle_settings_7 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_number['value_max'] >
	>
	type $mol_number__value_bog_pazzle_settings_8 = $mol_type_enforce<
		ReturnType< $bog_pazzle_settings['grid_columns'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_number__hint_bog_pazzle_settings_9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_number['hint'] >
	>
	type $mol_view__sub_bog_pazzle_settings_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_labeler__title_bog_pazzle_settings_11 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_pazzle_settings_12 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_view__sub_bog_pazzle_settings_13 = $mol_type_enforce<
		ReturnType< $bog_pazzle_settings['presets'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_check_box__title_bog_pazzle_settings_14 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_box['title'] >
	>
	type $mol_check_box__checked_bog_pazzle_settings_15 = $mol_type_enforce<
		ReturnType< $bog_pazzle_settings['numbers'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_button_minor__title_bog_pazzle_settings_16 = $mol_type_enforce<
		ReturnType< $bog_pazzle_settings['preset_title'] >
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_pazzle_settings_17 = $mol_type_enforce<
		ReturnType< $bog_pazzle_settings['preset_pick'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__attr_bog_pazzle_settings_18 = $mol_type_enforce<
		({ 
			'bog_pazzle_current': ReturnType< $bog_pazzle_settings['preset_current'] >,
		})  & ReturnType< $mol_button_minor['attr'] >
		,
		ReturnType< $mol_button_minor['attr'] >
	>
	export class $bog_pazzle_settings extends $mol_list {
		preset_title( id: any): string
		preset_pick( id: any, next?: any ): any
		preset_current( id: any): boolean
		Rows_input( ): $mol_number
		Times( ): $mol_text
		Columns_input( ): $mol_number
		Size_row( ): $mol_view
		Size( ): $mol_labeler
		presets( ): readonly(any)[]
		Presets( ): $mol_view
		Numbers( ): $mol_check_box
		grid_rows( next?: number ): number
		grid_columns( next?: number ): number
		numbers( next?: boolean ): boolean
		Preset( id: any): $mol_button_minor
		rows( ): readonly(any)[]
	}
...
declare namespace $.$$ {
    class $bog_pazzle_settings extends $.$bog_pazzle_settings {
        ...
        preset_title(size: number): string;
        preset_current(size: number): boolean;
        preset_pick(size: number, next?: any): null;
    }
}
...
declare namespace $ {
	...
	type $mol_labeler__title_bog_pazzle_upload_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_pazzle_upload_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_text__text_bog_pazzle_upload_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_text__text_bog_pazzle_upload_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_text__text_bog_pazzle_upload_5 = $mol_type_enforce<
		...
		ReturnType< $mol_text['text'] >
	>
	type $mol_button_major__title_bog_pazzle_upload_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_pazzle_upload_7 = $mol_type_enforce<
		ReturnType< $bog_pazzle_upload['start'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $bog_pazzle_upload_image__image_uri_bog_pazzle_upload_8 = $mol_type_enforce<
		ReturnType< $bog_pazzle_upload['image_uri'] >
		,
		ReturnType< $bog_pazzle_upload_image['image_uri'] >
	>
	type $bog_pazzle_upload_image__picked_bog_pazzle_upload_9 = $mol_type_enforce<
		ReturnType< $bog_pazzle_upload['picked'] >
		,
		ReturnType< $bog_pazzle_upload_image['picked'] >
	>
	type $bog_pazzle_settings__grid_rows_bog_pazzle_upload_10 = $mol_type_enforce<
		ReturnType< $bog_pazzle_upload['grid_rows'] >
		,
		ReturnType< $bog_pazzle_settings['grid_rows'] >
	>
	type $bog_pazzle_settings__grid_columns_bog_pazzle_upload_11 = $mol_type_enforce<
		ReturnType< $bog_pazzle_upload['grid_columns'] >
		,
		ReturnType< $bog_pazzle_settings['grid_columns'] >
	>
	type $bog_pazzle_settings__numbers_bog_pazzle_upload_12 = $mol_type_enforce<
		ReturnType< $bog_pazzle_upload['numbers'] >
		,
		ReturnType< $bog_pazzle_settings['numbers'] >
	>
	export class $bog_pazzle_upload extends $mol_list {
		...
		rows( ): ReturnType< $bog_pazzle_upload['upload_content'] >
	}
...
declare namespace $ {
	...
	type $mol_text__text_bog_pazzle_play_1 = $mol_type_enforce<
		ReturnType< $bog_pazzle_play['time'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_text__text_bog_pazzle_play_2 = $mol_type_enforce<
		ReturnType< $bog_pazzle_play['moves_label'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_check_box__title_bog_pazzle_play_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_box['title'] >
	>
	type $mol_check_box__hint_bog_pazzle_play_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_box['hint'] >
	>
	type $mol_check_box__checked_bog_pazzle_play_5 = $mol_type_enforce<
		ReturnType< $bog_pazzle_play['peek'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_button_minor__title_bog_pazzle_play_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__hint_bog_pazzle_play_7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_pazzle_play_8 = $mol_type_enforce<
		ReturnType< $bog_pazzle_play['again'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_view__sub_bog_pazzle_play_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
...
declare namespace $ {
	...
	type $mol_image__uri_bog_pazzle_saves_item_1 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves_item['thumb'] >
		,
		ReturnType< $mol_image['uri'] >
	>
	type $mol_image__title_bog_pazzle_saves_item_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_image['title'] >
	>
	type $mol_text__text_bog_pazzle_saves_item_3 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves_item['label'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_text__text_bog_pazzle_saves_item_4 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves_item['stat'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_list__rows_bog_pazzle_saves_item_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_button_minor__hint_bog_pazzle_saves_item_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_pazzle_saves_item_7 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves_item['open_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_pazzle_saves_item_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_button_minor__hint_bog_pazzle_saves_item_9 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves_item['drop_hint'] >
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_pazzle_saves_item_10 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves_item['drop_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__attr_bog_pazzle_saves_item_11 = $mol_type_enforce<
		({ 
			'bog_pazzle_confirm': ReturnType< $bog_pazzle_saves_item['confirm'] >,
		})  & ReturnType< $mol_button_minor['attr'] >
		,
		ReturnType< $mol_button_minor['attr'] >
	>
	type $mol_button_minor__sub_bog_pazzle_saves_item_12 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	export class $bog_pazzle_saves_item extends $mol_view {
		open_click( next?: any ): any
		thumb( ): string
		Thumb( ): $mol_image
		label( ): string
		Label( ): $mol_text
		...
		drop_hint( ): string
		drop_click( next?: any ): any
		confirm( next?: boolean ): boolean
		Drop_icon( ): $mol_icon_delete
...
declare namespace $.$$ {
    class $bog_pazzle_saves_item extends $.$bog_pazzle_saves_item {
        save(): $bog_pazzle_store_save | null;
        thumb(): string;
        label(): string;
        stat(): string;
        open_click(next?: any): null;
        drop_hint(): "Нажмите ещё раз, чтобы удалить" | "Удалить";
        /** Удаление в два клика — случайно снести собранный пазл обидно. */
        drop_click(next?: any): null;
    }
}
...
declare namespace $ {
	...
	type $mol_text__text_bog_pazzle_saves_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_button_major__hint_bog_pazzle_saves_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['hint'] >
	>
	type $mol_button_major__click_bog_pazzle_saves_3 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves['create'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_major__sub_bog_pazzle_saves_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $bog_pazzle_saves_item__id_bog_pazzle_saves_5 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves['row_id'] >
		,
		ReturnType< $bog_pazzle_saves_item['id'] >
	>
	type $bog_pazzle_saves_item__open_bog_pazzle_saves_6 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves['open'] >
		,
		ReturnType< $bog_pazzle_saves_item['open'] >
	>
	type $bog_pazzle_saves_item__drop_bog_pazzle_saves_7 = $mol_type_enforce<
		ReturnType< $bog_pazzle_saves['drop'] >
		,
		ReturnType< $bog_pazzle_saves_item['drop'] >
	>
	export class $bog_pazzle_saves extends $mol_list {
		row_id( id: any): string
		drop( next?: any ): any
		Empty( ): $mol_text
		Create_icon( ): $mol_icon_image_plus
		Create( ): $mol_button_major
		saves_content( ): readonly(any)[]
		open( next?: any ): any
		create( next?: any ): any
		Row( id: any): $bog_pazzle_saves_item
		rows( ): ReturnType< $bog_pazzle_saves['saves_content'] >
	}
	
}

//# sourceMappingURL=saves.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_pazzle_saves extends $.$bog_pazzle_saves {
        /** Битые записи в список не пускаем — иначе получится карточка-призрак. */
        ids(): readonly string[];
        row_id(id: string): string;
        saves_content(): readonly $mol_view[];
        drop(next?: string | null): string | null | undefined;
    }
}
...
declare namespace $ {
	...
	type $mol_text__text_bog_pazzle_help_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	export class $bog_pazzle_help extends $mol_list {
		Rules( ): $mol_text
		rows( ): readonly(any)[]
	}
...
declare namespace $ {
    ...
    const $bog_pazzle_pic_side = 900;
    /** Сторона миниатюры для списка сохранений. */
    const $bog_pazzle_pic_side_thumb = 240;
    function $bog_pazzle_pic_make(this: $, file: Blob): Promise<$bog_pazzle_pic>;
    /** Вписывает картинку в квадрат заданной стороны и отдаёт data-uri. */
    function $bog_pazzle_pic_fit(this: $, source: HTMLImageElement, side: number): string;
}
...
declare namespace $ {
	...
	type $bog_theme_toggle__theme_auto_bog_pazzle_1 = $mol_type_enforce<
		...
		ReturnType< $bog_theme_toggle['theme_auto'] >
	>
	type $bog_pazzle_menu__resumable_bog_pazzle_2 = $mol_type_enforce<
		ReturnType< $bog_pazzle['resumable'] >
		,
		ReturnType< $bog_pazzle_menu['resumable'] >
	>
	type $bog_pazzle_menu__saves_count_bog_pazzle_3 = $mol_type_enforce<
		ReturnType< $bog_pazzle['saves_count'] >
		,
		ReturnType< $bog_pazzle_menu['saves_count'] >
	>
	type $bog_pazzle_menu__home_bog_pazzle_4 = $mol_type_enforce<
		ReturnType< $bog_pazzle['go_home'] >
		,
		ReturnType< $bog_pazzle_menu['home'] >
	>
	type $bog_pazzle_menu__play_bog_pazzle_5 = $mol_type_enforce<
		ReturnType< $bog_pazzle['go_play'] >
		,
		ReturnType< $bog_pazzle_menu['play'] >
	>
	type $bog_pazzle_menu__saves_bog_pazzle_6 = $mol_type_enforce<
		ReturnType< $bog_pazzle['go_saves'] >
		,
		ReturnType< $bog_pazzle_menu['saves'] >
	>
	type $bog_pazzle_menu__help_bog_pazzle_7 = $mol_type_enforce<
		ReturnType< $bog_pazzle['go_help'] >
		,
		ReturnType< $bog_pazzle_menu['help'] >
	>
	type $bog_pazzle_board__image_uri_bog_pazzle_8 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_image'] >
		,
		ReturnType< $bog_pazzle_board['image_uri'] >
	>
	type $bog_pazzle_board__rows_bog_pazzle_9 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_rows'] >
		,
		ReturnType< $bog_pazzle_board['rows'] >
	>
	type $bog_pazzle_board__columns_bog_pazzle_10 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_columns'] >
		,
		ReturnType< $bog_pazzle_board['columns'] >
	>
	type $bog_pazzle_board__numbers_bog_pazzle_11 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_numbers'] >
		,
		ReturnType< $bog_pazzle_board['numbers'] >
	>
	type $bog_pazzle_board__order_bog_pazzle_12 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_order'] >
		,
		ReturnType< $bog_pazzle_board['order'] >
	>
	type $bog_pazzle_upload__image_uri_bog_pazzle_13 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_image'] >
		,
		ReturnType< $bog_pazzle_upload['image_uri'] >
	>
	type $bog_pazzle_upload__picked_bog_pazzle_14 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_picked'] >
		,
		ReturnType< $bog_pazzle_upload['picked'] >
	>
	type $bog_pazzle_upload__grid_rows_bog_pazzle_15 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_rows'] >
		,
		ReturnType< $bog_pazzle_upload['grid_rows'] >
	>
	type $bog_pazzle_upload__grid_columns_bog_pazzle_16 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_columns'] >
		,
		ReturnType< $bog_pazzle_upload['grid_columns'] >
	>
	type $bog_pazzle_upload__numbers_bog_pazzle_17 = $mol_type_enforce<
		ReturnType< $bog_pazzle['draft_numbers'] >
		,
		ReturnType< $bog_pazzle_upload['numbers'] >
	>
	type $bog_pazzle_upload__start_bog_pazzle_18 = $mol_type_enforce<
		ReturnType< $bog_pazzle['start'] >
		,
		ReturnType< $bog_pazzle_upload['start'] >
	>
	type $bog_pazzle_upload__Preview_bog_pazzle_19 = $mol_type_enforce<
		ReturnType< $bog_pazzle['Preview'] >
		,
		ReturnType< $bog_pazzle_upload['Preview'] >
	>
	type $bog_pazzle_board__playable_bog_pazzle_20 = $mol_type_enforce<
		boolean
		,
		ReturnType< $bog_pazzle_board['playable'] >
	>
	type $bog_pazzle_board__image_uri_bog_pazzle_21 = $mol_type_enforce<
		ReturnType< $bog_pazzle['image'] >
		,
		ReturnType< $bog_pazzle_board['image_uri'] >
	>
	type $bog_pazzle_board__rows_bog_pazzle_22 = $mol_type_enforce<
		ReturnType< $bog_pazzle['rows'] >
		,
		ReturnType< $bog_pazzle_board['rows'] >
	>
	type $bog_pazzle_board__columns_bog_pazzle_23 = $mol_type_enforce<
		ReturnType< $bog_pazzle['columns'] >
		,
		ReturnType< $bog_pazzle_board['columns'] >
	>
	type $bog_pazzle_board__numbers_bog_pazzle_24 = $mol_type_enforce<
		ReturnType< $bog_pazzle['numbers'] >
		,
		ReturnType< $bog_pazzle_board['numbers'] >
	>
	type $bog_pazzle_board__order_bog_pazzle_25 = $mol_type_enforce<
		ReturnType< $bog_pazzle['order'] >
		,
		ReturnType< $bog_pazzle_board['order'] >
	>
	type $bog_pazzle_board__moves_bog_pazzle_26 = $mol_type_enforce<
		ReturnType< $bog_pazzle['moves'] >
		,
		ReturnType< $bog_pazzle_board['moves'] >
	>
	type $bog_pazzle_board__time_bog_pazzle_27 = $mol_type_enforce<
		ReturnType< $bog_pazzle['time'] >
		,
		ReturnType< $bog_pazzle_board['time'] >
	>
	type $bog_pazzle_board__best_bog_pazzle_28 = $mol_type_enforce<
		ReturnType< $bog_pazzle['best'] >
		,
		ReturnType< $bog_pazzle_board['best'] >
	>
	type $bog_pazzle_board__peek_bog_pazzle_29 = $mol_type_enforce<
		ReturnType< $bog_pazzle['peek'] >
		,
		ReturnType< $bog_pazzle_board['peek'] >
	>
	type $bog_pazzle_board__apply_bog_pazzle_30 = $mol_type_enforce<
		ReturnType< $bog_pazzle['move'] >
		,
		ReturnType< $bog_pazzle_board['apply'] >
	>
	type $bog_pazzle_board__again_bog_pazzle_31 = $mol_type_enforce<
		ReturnType< $bog_pazzle['again'] >
		,
		ReturnType< $bog_pazzle_board['again'] >
	>
	type $bog_pazzle_board__home_bog_pazzle_32 = $mol_type_enforce<
		ReturnType< $bog_pazzle['go_home'] >
		,
		ReturnType< $bog_pazzle_board['home'] >
	>
	type $bog_pazzle_board__saves_bog_pazzle_33 = $mol_type_enforce<
		ReturnType< $bog_pazzle['go_saves'] >
		,
		ReturnType< $bog_pazzle_board['saves'] >
	>
	type $mol_button_minor__hint_bog_pazzle_34 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_bog_pazzle_35 = $mol_type_enforce<
		ReturnType< $bog_pazzle['go_home'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_pazzle_36 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $bog_pazzle_layout__Menu_bog_pazzle_37 = $mol_type_enforce<
		ReturnType< $bog_pazzle['Menu'] >
		,
		ReturnType< $bog_pazzle_layout['Menu'] >
	>
	type $bog_pazzle_layout__Upload_bog_pazzle_38 = $mol_type_enforce<
		ReturnType< $bog_pazzle['Upload'] >
		,
		ReturnType< $bog_pazzle_layout['Upload'] >
	>
	type $bog_pazzle_play__moves_bog_pazzle_39 = $mol_type_enforce<
		ReturnType< $bog_pazzle['moves'] >
		,
		ReturnType< $bog_pazzle_play['moves'] >
	>
	type $bog_pazzle_play__time_bog_pazzle_40 = $mol_type_enforce<
		ReturnType< $bog_pazzle['time'] >
		,
		ReturnType< $bog_pazzle_play['time'] >
	>
	type $bog_pazzle_play__peek_bog_pazzle_41 = $mol_type_enforce<
		ReturnType< $bog_pazzle['peek'] >
		,
		ReturnType< $bog_pazzle_play['peek'] >
	>
	type $bog_pazzle_play__again_bog_pazzle_42 = $mol_type_enforce<
		ReturnType< $bog_pazzle['again'] >
		,
		ReturnType< $bog_pazzle_play['again'] >
	>
	type $bog_pazzle_play__Game_bog_pazzle_43 = $mol_type_enforce<
		ReturnType< $bog_pazzle['Game'] >
		,
		ReturnType< $bog_pazzle_play['Game'] >
	>
	type $bog_pazzle_saves__open_bog_pazzle_44 = $mol_type_enforce<
		ReturnType< $bog_pazzle['open'] >
		,
		ReturnType< $bog_pazzle_saves['open'] >
	>
	type $bog_pazzle_saves__create_bog_pazzle_45 = $mol_type_enforce<
		ReturnType< $bog_pazzle['go_home'] >
		,
		ReturnType< $bog_pazzle_saves['create'] >
	>
	export class $bog_pazzle extends $mol_page {
		...
		Menu( ): $bog_pazzle_menu
		draft_image( ): string
		draft_picked( next?: any ): any
		draft_rows( next?: number ): number
		draft_columns( next?: number ): number
		draft_numbers( next?: boolean ): boolean
		...
		Game( ): $bog_pazzle_board
		plugins( ): readonly(any)[]
		title( ): ReturnType< $bog_pazzle['caption'] >
		tools( ): readonly(any)[]
		body( ): ReturnType< $bog_pazzle['screen'] >
		Back( ): $mol_button_minor
		go_home( next?: any ): any
		go_play( next?: any ): any
		go_saves( next?: any ): any
		go_help( next?: any ): any
		start( next?: any ): any
		again( next?: any ): any
		move( next?: any ): any
		open( next?: any ): any
		peek( next?: boolean ): boolean
		Home( ): $bog_pazzle_layout
		Play( ): $bog_pazzle_play
		Saves( ): $bog_pazzle_saves
		Help( ): $bog_pazzle_help
	}
...
declare namespace $.$$ {
    class $bog_pazzle extends $.$bog_pazzle {
        ...
        mode(): "" | "saves" | "play" | "help";
        screen(): readonly $mol_view[];
        caption(): string;
        head(): readonly $mol_view[];
        go_home(next?: any): null;
        go_play(next?: any): null;
        go_saves(next?: any): null;
        go_help(next?: any): null;
        save(): $bog_pazzle_store_save | null;
        image(): string;
        rows(): number;
        columns(): number;
        ...
        move(next?: $bog_pazzle_store_move | null): $bog_pazzle_store_move | null;
        again(next?: any): null;
        open(next?: string | null): string | null;
        draft(): $bog_pazzle_store_save | null;
        draft_image(): string;
        draft_rows(next?: number): number;
        draft_columns(next?: number): number;
        draft_numbers(next?: boolean): boolean;
        ...
        draft_order(): readonly number[];
        draft_patch(patch: Partial<$bog_pazzle_store_save>): void;
        draft_picked(next?: File | null): File | null;
        start(next?: any): null;
        resumable(): boolean;
        saves_count(): number;
    }
